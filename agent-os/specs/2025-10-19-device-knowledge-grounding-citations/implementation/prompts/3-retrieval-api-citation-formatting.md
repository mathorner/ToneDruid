We're continuing our implementation of Device Knowledge Grounding + Citations by implementing task group number 3:

## Implement this task and its sub-tasks:

Work through **Task Group 3: Retrieval API & Citation Formatting** in @agent-os/specs/2025-10-19-device-knowledge-grounding-citations/tasks.md. Refer back to that section for every subtask, dependency, and acceptance criterion.
