We're continuing our implementation of Device Knowledge Grounding + Citations by implementing task group number 5:

## Implement this task and its sub-tasks:

Work through **Task Group 5: Knowledge Grounding Console UI** in @agent-os/specs/2025-10-19-device-knowledge-grounding-citations/tasks.md. Rely on that section for the authoritative subtasks, dependencies, and acceptance criteria.
