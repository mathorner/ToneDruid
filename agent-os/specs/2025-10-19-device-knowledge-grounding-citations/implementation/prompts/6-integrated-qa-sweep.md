We're continuing our implementation of Device Knowledge Grounding + Citations by implementing task group number 6:

## Implement this task and its sub-tasks:

Work through **Task Group 6: Integrated QA Sweep** in @agent-os/specs/2025-10-19-device-knowledge-grounding-citations/tasks.md. Treat that section as the single source of truth for subtasks, dependencies, and acceptance criteria.
